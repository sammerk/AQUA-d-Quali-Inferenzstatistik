...
### Visualisierung
Die folgenden App zieht eine Stichprobe gewählter Größe und (wahrer) Effektstärke und berechnet den p-Wert für diese Stichprobe bzgl. der $H_0\text{: } \delta = 0$.

* Beobachtet was (durchschnittlich) mit dem p-Wert passiert, wenn ihr 
...
* Stellt $\delta=0$ ein und variiert $N$ beliebig. Wie sind die resultierenden p-Werte verteilt?
...
ui <- page_fluid(
 ...
 layout_column_wrap(
    ...
    value_box(
      ...
      p("Basierend auf der unten vorliegenden Stichprobe bzgl. H₀: 𝛅 = 0")
  )),
  card(
